...
function mapToAxiosConfig(requestConfig) {
  var _requestConfig$url, _requestConfig$auth, _requestConfig$respon, _requestConfig$respon2, _requestConfig$maxRed;
  ...
  const formConfig = (requestConfig === null || requestConfig === void 0 ? void 0 : requestConfig.formData) || (requestConfig === null || requestConfig === void 0 ? void 0 : requestConfig.form);
  const form = new _formData.default();

  if (!(0, _fp.isEmpty)(formConfig)) {
  ...
  const data = (requestConfig === null || requestConfig === void 0 ? void 0 : requestConfig.data) || (requestConfig === null || requestConfig === void 0 ? void 0 : requestConfig.body) || form;
  return { ...requestConfig,
    url: (_requestConfig$url = requestConfig.url) !== null && _requestConfig$url !== void 0 ? _requestConfig$url : requestConfig.uri,
    // method,
    // baseURL,
    // transformRequest,
    // transformResponse,
