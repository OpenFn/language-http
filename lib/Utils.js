...
function setUrl(configuration, path) {
  if (configuration && configuration.baseUrl) {
    const baseUrl = configuration.baseUrl.endsWith('/') ? configuration.baseUrl : `${configuration.baseUrl}/`;
    return `${baseUrl}${path}`;
  } else return path;
}
...
function mapToAxiosConfig(requestConfig) {
  var _requestConfig, _requestConfig2, _requestConfig3, _requestConfig4, _requestConfig5, _requestConfig$url, _requestConfig8, _requestConfig9, _requestConfig10, _requestConfig11, _requestConfig12, _requestConfig$data, _requestConfig13, _requestConfig14, _requestConfig$auth, _requestConfig15, _requestConfig16, _requestConfig$respon, _requestConfig17, _requestConfig$respon2, _requestConfig18, _requestConfig19, _requestConfig$maxRed, _requestConfig21, _requestConfig22;
  ...
  const finalConfig = { ...requestConfig,
    ...
    // paramsSerializer,
    data: (_requestConfig$data = (_requestConfig13 = requestConfig) === null || _requestConfig13 === void 0 ? void 0 : _requestConfig13.data) !== null && _requestConfig$data !== void 0 ? _requestConfig$data : ((_requestConfig14 = requestConfig) === null || _requestConfig14 === void 0 ? void 0 : _requestConfig14.body) || form,
    // timeouts,
    // withCredentials,
    // adapter,
    auth: (_requestConfig$auth = (_requestConfig15 = requestConfig) === null || _requestConfig15 === void 0 ? void 0 : _requestConfig15.auth) !== null && _requestConfig$auth !== void 0 ? _requestConfig$auth : (_requestConfig16 = requestConfig) === null || _requestConfig16 === void 0 ? void 0 : _requestConfig16.authentication,
    responseType: (_requestConfig$respon = (_requestConfig17 = requestConfig) === null || _requestConfig17 === void 0 ? void 0 : _requestConfig17.responseType) !== null && _requestConfig$respon !== void 0 ? _requestConfig$respon : 'json',
    responseEncoding: (_requestConfig$respon2 = (_requestConfig18 = requestConfig) === null || _requestConfig18 === void 0 ? void 0 : _requestConfig18.responseEncoding) !== null && _requestConfig$respon2 !== void 0 ? _requestConfig$respon2 : (_requestConfig19 = requestConfig) === null || _requestConfig19 === void 0 ? void 0 : _requestConfig19.encoding,
    // xsrfCookieName,
    // xsrfHeaderName,
    // onUploadProgress,
    // onDownloadProgress,
