...
function get(path, params, callback) {
  return function (state) {
    ...
    return (0, _Client.req)('GET', _objectSpread({
      url: url,
      query: query,
      auth: auth,
      headers: headers,
...
function post(path, params, callback) {
  return function (state) {
    ...
    var auth = (0, _Utils.setAuth)(state.configuration, authentication);
    return (0, _Client.req)('POST', _objectSpread({
      url: url,
      query: query,
      body: body,
      auth: auth,
...
function put(path, params, callback) {
  return function (state) {
    ...
    var auth = (0, _Utils.setAuth)(state.configuration, authentication);
    return (0, _Client.req)('PUT', _objectSpread({
      url: url,
      query: query,
      body: body,
      formData: formData,
...
function patch(path, params, callback) {
  return function (state) {
    ...
    var auth = (0, _Utils.setAuth)(state.configuration, authentication);
    return (0, _Client.req)('PATCH', _objectSpread({
      url: url,
      query: query,
      body: body,
      formData: formData,
...
function del(path, params, callback) {
  return function (state) {
    ...
    var auth = (0, _Utils.setAuth)(state.configuration, authentication);
    return (0, _Client.req)('DELETE', _objectSpread({
      url: url,
      query: query,
      body: body,
      formData: formData,
