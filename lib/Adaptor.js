...
function get(path, params, callback) {
  ...
  return function (state) {
    ...
    (0, _Client.req)("GET", { url: url, query: query, auth: auth, headers: headers }).then(function (response) {
...
function post(path, params, callback) {
  ...
  return function (state) {
    ...
    (0, _Client.req)("POST", { url: url, query: query, body: body, auth: auth, headers: headers }).then(function (response) {
...
function put(path, params, callback) {
  ...
  return function (state) {
    ...
    (0, _Client.req)("PUT", { url: url, query: query, body: body, auth: auth, headers: headers }).then(function (response) {
      // TODO: Decide if response goes to head or tail of the data array...
      var nextState = _extends({}, state, { data: [].concat(_toConsumableArray(state.data), [response]) });
      if (callback) return callback(nextState);
      return nextState;
...
function patch(path, params, callback) {
  ...
  return function (state) {
    ...
    (0, _Client.req)("PATCH", { url: url, query: query, body: body, auth: auth, headers: headers }).then(function (response) {
      // TODO: Decide if response goes to head or tail of the data array...
      var nextState = _extends({}, state, { data: [].concat(_toConsumableArray(state.data), [response]) });
      if (callback) return callback(nextState);
      return nextState;
...
function del(path, params, callback) {
  ...
  return function (state) {
    ...
    (0, _Client.req)("DELETE", { url: url, query: query, body: body, auth: auth, headers: headers }).then(function (response) {
      // TODO: Decide if response goes to head or tail of the data array...
      var nextState = _extends({}, state, { data: [].concat(_toConsumableArray(state.data), [response]) });
      if (callback) return callback(nextState);
      return nextState;
