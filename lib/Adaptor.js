...
function get(path, params, callback) {
  return state => {
    ...
    const auth = (0, _Utils.setAuth)(state.configuration, (_resolvedParams$authe = resolvedParams === null || resolvedParams === void 0 ? void 0 : resolvedParams.authentication) !== null && _resolvedParams$authe !== void 0 ? _resolvedParams$authe : resolvedParams === null || resolvedParams === void 0 ? void 0 : resolvedParams.auth);
...
function post(path, params, callback) {
  return state => {
    ...
    const url = (0, _Utils.setUrl)(state.configuration, resolvedPath);
    const auth = (0, _Utils.setAuth)(state.configuration, (_resolvedParams$authe2 = resolvedParams === null || resolvedParams === void 0 ? void 0 : resolvedParams.authentication) !== null && _resolvedParams$authe2 !== void 0 ? _resolvedParams$authe2 : resolvedParams === null || resolvedParams === void 0 ? void 0 : resolvedParams.auth);
    const config = (0, _Utils.mapToAxiosConfig)({ ...resolvedParams,
      url,
      auth
    });
...
function put(path, params, callback) {
  return state => {
    ...
    const url = (0, _Utils.setUrl)(state.configuration, resolvedPath);
    const auth = (0, _Utils.setAuth)(state.configuration, (_resolvedParams$authe3 = resolvedParams === null || resolvedParams === void 0 ? void 0 : resolvedParams.authentication) !== null && _resolvedParams$authe3 !== void 0 ? _resolvedParams$authe3 : resolvedParams === null || resolvedParams === void 0 ? void 0 : resolvedParams.auth);
    const config = (0, _Utils.mapToAxiosConfig)({ ...resolvedParams,
      url,
      auth
    });
...
function patch(path, params, callback) {
  return state => {
    ...
    const url = (0, _Utils.setUrl)(state.configuration, resolvedPath);
    const auth = (0, _Utils.setAuth)(state.configuration, (_resolvedParams$authe4 = resolvedParams === null || resolvedParams === void 0 ? void 0 : resolvedParams.authentication) !== null && _resolvedParams$authe4 !== void 0 ? _resolvedParams$authe4 : resolvedParams === null || resolvedParams === void 0 ? void 0 : resolvedParams.auth);
    const config = (0, _Utils.mapToAxiosConfig)({ ...resolvedParams,
      url,
      auth
    });
...
function del(path, params, callback) {
  return state => {
    ...
    const url = (0, _Utils.setUrl)(state.configuration, resolvedPath);
    const auth = (0, _Utils.setAuth)(state.configuration, (_resolvedParams$authe5 = resolvedParams === null || resolvedParams === void 0 ? void 0 : resolvedParams.authentication) !== null && _resolvedParams$authe5 !== void 0 ? _resolvedParams$authe5 : resolvedParams.auth);
    const config = (0, _Utils.mapToAxiosConfig)({ ...resolvedParams,
      url,
      auth
    });
